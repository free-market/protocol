...
export const Layout = (props: {
  ...
  return (
    <div className="sm:flex items-stretch max-h-full h-full overflow-hidden bg-stone-900">
      <div className="w-14 shrink-0 box-content sm:h-screen overflow-hidden">
        <div
          className="p-3 border-b sm:border-b-0 border-stone-800 select-none bg-repeat bg-[length:70px_70px] w-full sm:h-screen bg-[url('/fmp-logo-repeat.svg')] "
          style={{
      ...
      <div className="text-stone-200 w-96 px-3 sm:h-screen sm:overflow-y-auto shrink grow-0 space-y-2">
        {stepCatalog}
      </div>
