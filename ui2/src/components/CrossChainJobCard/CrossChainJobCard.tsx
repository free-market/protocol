...
export const CrossChainJobCard = (props: {
  ...
  const avalanchePill = (
    <div className="rounded bg-[#E84142] w-[calc(100%-2rem)] h-4 flex justify-between relative overflow-hidden border border-stone-600 hover:border-stone-300">
  ...
  return (
    <>
      <div className="w-full bg-stone-600 rounded-xl shadow-md text-stone-200 font-medium p-2 max-w-xs mx-auto space-y-2 overflow-hidden">
