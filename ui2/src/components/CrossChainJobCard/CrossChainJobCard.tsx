import { FeePredictionData } from '@component/DepositFlowStateProvider/types'
import {
  ArrowRightIcon,
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between text-xs px-4 border border-transparent text-stone-300 font-light">
                      <div>Slippage</div>
                      <div>{fee.slippage}</div>
                    </div>
                    <div className="flex items-center justify-between text-xs px-4 border border-transparent text-stone-300 font-light">
                      <div>Gas on destination</div>
                      <div>
                        {fee.destination.gasPrice} {destinationGasSymbol}
                      </div>
                    </div>
                    <div className="flex items-center justify-between text-xs px-4 border border-transparent text-stone-400 font-light">
                      ...
                      <div className="flex items-center gap-1">
                        $
                        {Math.ceil(
                          (Number(fee.suppliedAmount) -
                            Number(fee.protocol.usd)) *
                            100,
                        ) / 100}
                      </div>
                    </div>
                    <div className="flex items-center justify-between text-xs px-4 border border-transparent text-stone-400 font-light">
                      <div>Gas cost</div>
                      <div>
                        {fee.source.gasPrice} {sourceGasSymbol}
                      </div>
                    </div>
                  </div>
                </div>
