  ...
  (
    ...
    const formCard = (
      <motion.div
        ...
        className="bg-zinc-700 rounded-xl p-2 max-w-sm mx-auto shadow-md relative overflow-hidden"
      >
        <AnimatePresence>
          {formEditingMode?.name === 'token' &&
            formEditingMode.recently !== 'closed' && (
              ...
              <div className="space-y-4 mt-16">
                <AnimatePresence>
                  <motion.h2
                    ...
                    className="text-zinc-600 text-2xl font-medium max-w-sm mx-auto my-0 text-center"
                  >
                    Start a deposit
                  </motion.h2>
                  ...
                  <motion.h4
                    ...
                    className="text-zinc-500 text-sm max-w-sm mx-auto my-0 text-center font-medium"
                  >
