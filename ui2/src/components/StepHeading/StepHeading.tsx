  ...
  return (
    <div className="bg-zinc-700 p-2 rounded-xl cursor-pointer hover:bg-zinc-600 active:bg-zinc-600/75 select-none flex items-center justify-between group" onClick={click}>
      <div className="flex items-center">
        <img src='https://curve.fi/favicon-32x32.png' className="w-8 h-8 group-active:opacity-75"/>
        <div className="text-zinc-300 text-lg px-2 group-active:opacity-75">Curve</div>
      </div>
