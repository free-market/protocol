...
export const StepHeading = (): JSX.Element => {
  ...
  return (
    <div className="bg-zinc-700 p-2 rounded-xl cursor-pointer hover:bg-zinc-600 active:opacity-75 select-none flex items-center justify-between group" onClick={click}>
