...
import { serialize as borshSerialize, field, OverrideType } from '@dao-xyz/borsh'
 ...
 */
export const GREETING_SIZE = borsh.serialize(GreetingSchema, new GreetingAccount()).length
