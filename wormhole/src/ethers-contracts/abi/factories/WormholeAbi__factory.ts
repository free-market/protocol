...
export class WormholeAbi__factory {
  static readonly abi = _abi;
  static createInterface(): WormholeAbiInterface {
    return new utils.Interface(_abi) as WormholeAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WormholeAbi {
    return new Contract(address, _abi, signerOrProvider) as WormholeAbi;
  }
}
